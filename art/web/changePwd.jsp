...
<head>
   <%@include file="/common/header.jsp" %>
	...
	function goSubmit(){
		  ...
		  if(!checkString(pwd,"新密码",30,true)) return;
		  ...
		  document.forms[0].action=fulllink+"?action=SAVEMYPWD";
  ...
  <s:form action="sysUser" id="userForm" method="post" namespace="/system">
  	<s:hidden name="record.id" />
		<table cellpadding="0" cellspacing="0" width="100%" class="formTable">
			 <tr >
				  <td width="35%"><font color="red">*</font>旧密码：</td>
				  <td width="65%">
					   <s:password name="record.oldPwd" />
				  </td>
			 </tr>
			 <tr >
				  <td width="35%"><font color="red">*</font>新密码：</td>
				  <td width="65%">
