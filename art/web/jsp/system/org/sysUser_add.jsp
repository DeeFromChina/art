  ...
  <s:form action="sysUser" id="userForm" method="post" namespace="/system">
		...
		<table id="tblForm" cellpadding="0" cellspacing="0" width="99%" class="formTable">
			 ...
			 <tr>
				  ...
				  <td ><s:password name="record.userPassword" /></td>
				  <td class="textR"><font color="red">*</font>确认密码：</td>
				  <td><s:password name="record.confirmPassword" /></td>
			 </tr>
			 <tr>
				  <td  class="textR"><font color="red">*</font>单位：</td>
				  <td class="sel">
			 ...
			 <tr>
				  ...
				  <td colspan="3" class="sel">
				  	 <table cellspacing="0" width="100%"  class="tbnBtnStyle">
		   	           ...
		   	           <td width="45px"><gl:button name="btnRoles" styleClass="btnFormStyle"  onClick="goRoles()">角色</gl:button></td>
			          </tr>
			       </table>
			    </td>      
			</tr>
