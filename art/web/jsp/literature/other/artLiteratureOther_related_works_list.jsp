...
<script language="javascript">
	...
	var pageAction = "?action=RELATED_WORKS_PAGE";

	function goAdd() {
		editMode = "ADD";
		openWindow("添加", fulllink + '?action=RELATED_WORKS_ADD&query.parameters.otherId='+$$('otherId').value, 0.7, 0.9);
	}
	...
	function goDel() {
		...
		if (res == true) {
			var data = ajaxSubmit(fulllink + "?action=RELATED_WORKS_DELETE&ids=" + id,
...
<body onload="init()">
	<div class="special-padding" id="mainDiv">
		<s:form action="ArtLiteratureOther" id="ArtLiteratureOtherForm"
			...
			<s:hidden name="query.parameters.otherId" id="otherId"/>
