...
<script language="javascript">		
	...
	function goSubmit() {
		if(checkFormInput()){
		    //var url =fulllink+"?action=SAVE"+ping("record.literatureWorks")+ping("record.quoteLiterature")+ping("record.personInvolved")/+ping("record.relatedExhib")+ping("record.relatedEvent");
