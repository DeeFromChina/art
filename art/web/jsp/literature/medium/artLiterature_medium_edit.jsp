...
<body onload="init()">
<s:form action="ArtLiteratureMedium" id="ArtLiteratureMediumForm" method="post" namespace="/literature"
    ...
    <div id="formDiv" class="formDiv" style="padding: 0px;">
        <table cellpadding="0" cellspacing="0" width="99%" class="formTable">
                        ...
                        <s:iterator value="cookie" id="c" status="co">
                            <tr>
                                <td class="textL" style="width:90%;">
                                    ...
                                    <a href="<%=CONTEXT_PATH%>upload/literature/medium/<s:property value="record.id"/>/${c.saveName}"
            ...
            <tr>
                ...
                <td><s:select list="codeSets.COMMENT_LEVEL" listKey="value" listValue="codeName"
                              name="record.subjectiveEval"/></td>
                <td class="textR" width="15%">客观重要度评级：</td>
                <td><s:select list="codeSets.COMMENT_LEVEL" listKey="value" listValue="codeName"
                              name="record.objectiveEval"/></td>
            </tr>
            <tr>
