...
<script type="text/javascript">
    ...
    window.frames["page_1"].location.href=artistlink+'?action=LIST&query.parameters.exhibitId='+$$('id').value;
    }
    ...
    window.frames["page_2"].location.href=workslink+'?action=WORKS&query.parameters.exhibitId='+$$('id').value+"&record.zhan=1";
</script>
