  ...
  <s:form method="post" action="/activity/ArtActivityExhibit.do">
  	 ...
  	 <s:iterator value="query.recordSet" id="item">
  	    <input type="radio" style="width:16px;" <s:property value="CHECKED"/> name="artArtistId" value="<s:property value='id'/>" 
	   	title="<s:property value='worksCName'/>" /><img style="width:16px;" src="<%=CONTEXT_PATH%>dhtmlx/imgs/icon/people.gif" /><span style="width:200px;"><s:property value='worksCName'/></span><br/>
  	 </s:iterator>
  </s:form>		
</div>
