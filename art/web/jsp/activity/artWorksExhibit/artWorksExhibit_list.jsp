   ...
   <%@include file="/common/header.jsp" %>
	...
	var fulllink_exhibit = contextpath + "activity/ArtActivityExhibit.do";
		...
		function goAdd() {
			...
			var type = $$('type').value;
			var url_link = fulllink+"?action=ADD"+"&record.worksId="+worksId+"&query.parameters.type="+type;
		    openWindow("选择展览",url_link,0.8,0.8);	
		}
...
<s:hidden name="query.parameters.exhibitId" id="exhibitId" />
  ...
  &nbsp;&nbsp;艺术家名称：<s:textfield style="width:200px;" name="query.parameters.artistName" /> 
...
<gl:grid styleClass="pageTurn" id="pub" page="true" form="publicationForm"  property="query" cellPadding="0" cellSpacing="0" >
   ...
   grid.setHeader("#master_checkbox,展览名称,机构,艺术家,展览类别,国家,城市,年份,月份",null,headAlign);
   grid.setInitWidthsP("5,20,10,10,10,10,15,10,10");
