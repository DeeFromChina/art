...
<head>
    ...
    <script language="javascript">
        ...
        function checkFormInput() {
            ...
            if (!checkString(getElement('form.record.caseTime'), "时间", 30, true)) return;
            return true;
        }
...
<body onload="init()">
    <s:form action="ArtistWorksSeries" id="ArtistWorksSeriesForm" method="post" namespace="/artist">
        <s:hidden name="form.record.seriesId" id="seriesId"/>
        <div id="formDiv" class="formDiv" style="padding: 0px;">
            <table cellpadding="0" cellspacing="0" width="99%" class="formTable">
                ...
                <tr>
                    <td class="textR" width="15%"><font color="red">*</font>内容：</td>
