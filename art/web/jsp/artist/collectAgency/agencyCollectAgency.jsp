  ...
  <s:form method="post" action="/system/artAgency.do">
  	 ...
  	 <s:iterator value="query.recordSet" id="item">
  	    <input type="radio" style="width:16px;" <s:property value="CHECKED"/> name="createCountry" value="<s:property value='id'/>" 
	   	title="<s:property value='agencyCName'/>" /><img style="width:16px;" src="<%=CONTEXT_PATH%>dhtmlx/imgs/icon/people.gif" /><span style="width:100px;"><s:property value="agencyCName"/></span><br/>
  	 </s:iterator>
  </s:form>		
</div>
