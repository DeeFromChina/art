	...
	function addFileRow(loadName){
		 ...
		 if('tblUpload' == loadName){
			 if(rows>=5){
				 ...
				 one.innerHTML='<input type="text" placeholder="位置名称" class="partSize_l" name="record.partSize_name" style="width:23%;"'
					   +'/>&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<input type="text" placeholder="长" class="partSize_l" name="record.partSize_l" style="width:23%;"'
					   +'/>&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;<input type="text" placeholder="宽" class="partSize_l" name="record.partSize_w" style="width:23%;"'
					   +'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" placeholder="尺寸单位" class="partSize_l" name="record.partSize_unit" style="width:23%;"'
					   +'/>';
	...
	<s:form action="artWorks" id="artWorksForm" method="post" namespace="/works" enctype="multipart/form-data">
			...
			<table cellpadding="0" cellspacing="0" width="90%" class="formTable">
				...
				<tr>
					...
					<td class="textL"><s:select list="codeSets.WORKS_WRITING" listKey="value" listValue="codeName" name="record.worksWriting"/></td>
				</tr>
				<tr>
				...
				<tr >
					...
					<s:if test="record.Psize.toString() == 'no'">
					     <tr>
							<td width="90%" class="textL"><input type="button" style="width:50px;" value="增加" onclick="addFileRow('tblUpload')"/></td>
								      <td></td>
						</tr>		      
					</s:if>
				...
				<tr>
					...
					<td class="textL"><s:select list="codeSets.SIGNATURE" listKey="value" listValue="codeName" name="record.signature"/></td>
				...
				<tr>
					...
					<td class="textL"><s:select list="codeSets.SIGNATURE" listKey="value" listValue="codeName" name="record.signature2"/></td>
					<td class="textR">签名内容2：</td>
					<td class="textL" colspan="3"><s:textfield name="record.signatureContent2"/></td>
				</tr>
				<tr>
					<td class="textR">签名位置3：</td>
					<td class="textL"><s:select list="codeSets.SIGNATURE" listKey="value" listValue="codeName" name="record.signature3"/></td>
				...
				<tr>
					...
					<td colspan="5" rowspan="5" class="textL">
						<table  id="tblUpload1" cellpadding="0" cellspacing="0" width="100%"  class="tbnBtnStyle" align="left">
						   <tr>
						      <td class="textL"><input type="button" style="width:50px;" value="增加" onclick="addFileRow('tblUpload1')"/></td>
						      <td width="10%"></td>
						   </tr>
				...
				<tr>
					...
					<td class="textL" colspan="3"><s:select list="codeSets.PHOTO_SOURE" listKey="value" listValue="codeName" name="record.photoSoure"/></td>
				</tr>
				<tr>
...
function goResize(){
	   ...
	   bDiv.style.width=mainbody.offsetWidth-40+"px";
	   bDiv.style.height=40+"px";
	   bDiv.style.top=btbl.offsetHeight+"px";
	}
	goResize(); 
fDiv.style.height=btbl.offsetHeight-30+"px";
</script>
</body>
</html>