...
<div id="formDiv" class="formDiv" style="left:0px;top:0px;text-align:left!important;background:white;border:1px solid #c1b2ff!important;">
  <s:form method="post" action="/works/artWorks.do">
  	 ...
  	 <s:iterator value="query.recordSet" id="item">
  	    <input type="checkbox" style="width:16px;" <s:property value="CHECKED"/> name="STYLE" value="<s:property value='id'/>" 
	   	title="<s:property value='styleName'/>" /><img style="width:16px;" src="<%=CONTEXT_PATH%>dhtmlx/imgs/icon/people.gif" /><span style="width:100px;"><s:property value="styleName"/></span><br/>
  	 </s:iterator>
  </s:form>		
</div>
