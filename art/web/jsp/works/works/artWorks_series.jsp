  ...
  <s:form method="post" action="/works/artWorks.do">
  	 ...
  	 <s:iterator value="query.recordSet" id="item">
  	    <input type="radio" style="width:16px;" <s:property value="CHECKED"/> name="createCountry" value="<s:property value='id'/>" 
	   	title="<s:property value='seriesName'/>" /><img style="width:16px;" src="<%=CONTEXT_PATH%>dhtmlx/imgs/icon/people.gif" /><span style="width:100px;"><s:property value="seriesName"/></span><br/>
  	 </s:iterator>
  </s:form>		
</div>
