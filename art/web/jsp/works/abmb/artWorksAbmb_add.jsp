...
<script language="javascript">  
	var hyperlink = contextpath + "works/ArtWorksAbmb.do";
	var fulllink = contextpath + "works/ArtWorksAbmb.do";
	var fulllink_exhibit = contextpath + "activity/activityAbmb.do";
	
	function view(id) {
	       var url_link=fulllink_exhibit+'?action=VIEW&ids='+id;
	       editMode="VIEW";
	       openWindow("查看展览信息",url_link,0.8,0.4);	
	}
		  ...
		  &nbsp;&nbsp;<gl:button name="btnQuery" onClick="goSearch()">查询</gl:button>
			...
			<gl:grid styleClass="pageTurn" id="ArtistInformation" page="true" form="ArtistInformationForm"  property="query" cellPadding="0" cellSpacing="0">
				...
				var headAlign=[tLeft,tCenter,tCenter,tCenter,tCenter,tCenter];
   				grid.setHeader("#master_checkbox,名称,主办方,届数,国家,城市",null,headAlign);
