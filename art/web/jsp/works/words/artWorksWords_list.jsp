...
<head>
   <%@include file="/common/header.jsp" %>
	...
	var hyperlink = "../works/ArtWorksWords.do";
	var fulllink = contextpath + "works/ArtWorksWords.do";
	var fulllink_exhibit = contextpath + "literature/ArtLiteratureWords.do";
	...
	<table width="100%" id="tbl" cellpadding="0" cellspacing="0" class="queryTable">
		...
		<tr>
            <td class="textL">
                ...
                &nbsp;&nbsp;出版物名称：<s:textfield style="width:200px;" name="query.parameters.publicationName" />
...
<gl:grid styleClass="pageTurn" id="pub" page="true" form="publicationForm"  property="query" cellPadding="0" cellSpacing="0" >
   ...
   grid.setHeader("#master_checkbox,标题,作者,出版物名称,文献提及作品,引用文献,文献相关人物,文献相关展览,文献相关事件",null,headAlign);
