...
/**
 * This is an object that contains data related to the art_activity_exhibit_artist table.
 */
@Entity  
@Table(name="art_activity_exhibit_artist")  
public class ArtActivityExhibitArtist implements Serializable {
   ...
   // Constructors
   public ArtActivityExhibitArtist() {
   }
   ...
   public static String REF_CLASS = "ArtActivityExhibitArtist";
   public static String PROP_ID = "id";
   public static String PROP_EXHIBIT_ID = "exhibitId";
   public static String PROP_ARTIST_ID = "artistId";

   public static String REF_TABLE = "art_activity_exhibit_artist";
   ...
   public boolean equals(Object obj) {
      ...
      if (!(obj instanceof com.golead.art.activity.model.ArtActivityExhibitArtist)) return false;
      else {
         com.golead.art.activity.model.ArtActivityExhibitArtist o = (com.golead.art.activity.model.ArtActivityExhibitArtist) obj;
   ...
   public String toString() {
		...
		buffer.append("[ArtActivityExhibitArtist:");
