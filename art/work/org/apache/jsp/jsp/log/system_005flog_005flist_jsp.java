 ...
 * Generated at: 2016-12-15 09:16:57 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.jsp.log;
...
public final class system_005flog_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   String path = request.getContextPath();
	...
	String skinName="dhx_skyblue";
      ...
      out.write("\r\n");
      out.write("    <script language=\"javascript\">\r\n");
      out.write("        var hyperlink = \"../system/sysLog.do\";\r\n");
      out.write("        var fulllink = contextpath + \"/system/sysLog.do\";\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        function goDel() {\r\n");
      out.write("            if ($$('period').style.display != \"none\") {\r\n");
      out.write("                var beginTime = $$('beginTime').value;\r\n");
      out.write("                var endTime = $$('endTime').value;\r\n");
      out.write("\r\n");
      out.write("                if (isEndDateGreater(beginTime, endTime)) {\r\n");
      out.write("                    if (confirm(\"是否要清除该时间段内的日志么？\")) {\r\n");
      out.write("                        console.log(beginTime);\r\n");
      out.write("                        console.log(endTime);\r\n");
      out.write("                        var data = ajaxSubmit(fulllink + \"?action=delete\", \"sysLogForm\");\r\n");
      ...
      out.write("                }\r\n");
      out.write("            } else {\r\n");
      out.write("                $$('period').style.display = \"\";\r\n");
      out.write("                alert(\"请填写时间段\");\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function cleanTime() {\r\n");
      out.write("            $$('period').style.display = \"none\";\r\n");
      out.write("            $$('beginTime').value = \"\";\r\n");
      ...
      out.write("\r\n");
      out.write("            gosysLogGridSearch();\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function compareDate(date1, date2) {\r\n");
      out.write("            return Date.parse(date1) <= Date.parse(date2);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function isEndDateGreater(startDate, endDate) {\r\n");
      out.write("            var dateS = new Date(startDate.replace(/-/g, \"/\"));\r\n");
      out.write("            var dateE = new Date(endDate.replace(/-/g, \"/\"));\r\n");
      out.write("            if (compareDate(dateS, dateE)) {\r\n");
      out.write("                return true;\r\n");
      out.write("            } else {\r\n");
      out.write("                alert(\"开始时间应该早于结束时间\");\r\n");
      ...
      if (_jspx_meth_s_005fproperty_005f0(_jspx_page_context))
        return;
      out.write("');\r\n");
      out.write("            var beginTime = initCalendar(\"beginTime\", \"imgBeginTime\");\r\n");
      out.write("            var endTime = initCalendar(\"endTime\", \"imgEndTime\");\r\n");
      out.write("            renew();\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("\r\n");
      ...
      // /jsp/log/system_log_list.jsp(103,4) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setAction("sysLog");
      // /jsp/log/system_log_list.jsp(103,4) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setId("sysLogForm");
      // /jsp/log/system_log_list.jsp(103,4) name = method type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setMethod("post");
      // /jsp/log/system_log_list.jsp(103,4) name = namespace type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("            <tr>\r\n");
          out.write("                <td>\r\n");
          out.write("                    <sapn id=\"period\" style=\"display: none\">\r\n");
          out.write("                        &nbsp;&nbsp;开始时间：");
          if (_jspx_meth_s_005ftextfield_005f2(_jspx_th_s_005fform_005f0, _jspx_page_context))
            return;
          out.write("\r\n");
          out.write("                        <span style=\"width: 15px;\">\r\n");
          out.write("                            <img id=\"imgBeginTime\" style=\"cursor:pointer;\"\r\n");
          out.write("                                 src=\"");
          out.print(CONTEXT_PATH);
          ...
          out.write("\r\n");
          out.write("                        <span style=\"width: 15px;\">\r\n");
          out.write("                            <img id=\"imgEndTime\" style=\"cursor:pointer;\"\r\n");
          out.write("                                 src=\"");
          out.print(CONTEXT_PATH);
          out.write("dhtmlx/imgs/icon/7-4.gif\"/>\r\n");
          out.write("                        </span>\r\n");
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(86,25) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f0.setValue("errorMessage");
    // /jsp/log/system_log_list.jsp(86,25) name = escape type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(104,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f0.setName("record.hide");
    // /jsp/log/system_log_list.jsp(104,8) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(105,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(106,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(107,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(108,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(109,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(113,36) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f0.setCssStyle("width:100px;");
    // /jsp/log/system_log_list.jsp(113,36) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f0.setName("query.parameters.operator");
  ...
  private boolean _jspx_meth_s_005ftextfield_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(114,35) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f1.setCssStyle("width:100px;");
    // /jsp/log/system_log_list.jsp(114,35) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f1.setName("query.parameters.operModule");
  ...
  private boolean _jspx_meth_gl_005fbutton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(115,32) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f0.setName("btnQuery");
    // /jsp/log/system_log_list.jsp(115,32) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(123,41) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f2.setId("beginTime");
    // /jsp/log/system_log_list.jsp(123,41) name = readonly type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f2.setReadonly("true");
    // /jsp/log/system_log_list.jsp(123,41) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f2.setName("record.beginTime");
  ...
  private boolean _jspx_meth_s_005ftextfield_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  s:textfield
    org.apache.struts2.views.jsp.ui.TextFieldTag _jspx_th_s_005ftextfield_005f3 = (org.apache.struts2.views.jsp.ui.TextFieldTag) _005fjspx_005ftagPool_005fs_005ftextfield_0026_005freadonly_005fname_005fid_005fnobody.get(org.apache.struts2.views.jsp.ui.TextFieldTag.class);
    ...
    // /jsp/log/system_log_list.jsp(128,41) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f3.setId("endTime");
    // /jsp/log/system_log_list.jsp(128,41) name = readonly type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f3.setReadonly("true");
    // /jsp/log/system_log_list.jsp(128,41) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f3.setName("record.endTime");
    ...
    if (_jspx_th_s_005ftextfield_005f3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005fs_005ftextfield_0026_005freadonly_005fname_005fid_005fnobody.reuse(_jspx_th_s_005ftextfield_005f3);
      return true;
    }
    _005fjspx_005ftagPool_005fs_005ftextfield_0026_005freadonly_005fname_005fid_005fnobody.reuse(_jspx_th_s_005ftextfield_005f3);
    return false;
  ...
  private boolean _jspx_meth_gl_005fbutton_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(134,20) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setStyleClass("sbuBtnStyle");
    // /jsp/log/system_log_list.jsp(134,20) name = icon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setIcon("delIcon");
    // /jsp/log/system_log_list.jsp(134,20) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fgrid_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/log/system_log_list.jsp(138,8) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setStyleClass("pageTurn");
    // /jsp/log/system_log_list.jsp(138,8) name = id type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setId("sysLog");
    // /jsp/log/system_log_list.jsp(138,8) name = page type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setPage("true");
    // /jsp/log/system_log_list.jsp(138,8) name = form type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setForm("sysLogForm");
    // /jsp/log/system_log_list.jsp(138,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setProperty("query");
    // /jsp/log/system_log_list.jsp(138,8) name = cellPadding type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setCellPadding("0");
    // /jsp/log/system_log_list.jsp(138,8) name = cellSpacing type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
