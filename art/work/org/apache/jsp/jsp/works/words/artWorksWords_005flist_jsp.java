 ...
 * Generated at: 2016-12-09 03:16:55 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.jsp.works.words;
...
public final class artWorksWords_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   String path = request.getContextPath();
	...
	String skinName="dhx_skyblue";
      ...
      out.write("\r\n");
      out.write("\t<script language=\"javascript\">\t\t\r\n");
      out.write("\tvar hyperlink = \"../works/ArtWorksWords.do\";\r\n");
      out.write("\tvar fulllink = contextpath + \"works/ArtWorksWords.do\";\r\n");
      out.write("\tvar fulllink_exhibit = contextpath + \"literature/ArtLiteratureWords.do\";\r\n");
      out.write("\r\n");
      out.write("\t\t// 用于浏览该题材下的用户\r\n");
      out.write("\t\tfunction view(id) {\r\n");
      out.write("\t\t\teditMode=\"VIEW\";\r\n");
      out.write("\t\t\topenWindow(\"查看媒体\", fulllink_exhibit + \"?action=view&record.id=\" + id, 0.8, 0.8);\r\n");
      out.write("\t\t}\r\n");
      out.write("   \r\n");
      out.write("\t\tfunction goDel() {\r\n");
      out.write("\t\t\tvar id = findMultiSelected(\"删除\",pub_grid);\r\n");
      out.write("\t\t\tif(id == \"\") return;\r\n");
      out.write("\t\t\tvar res = confirm(\"是否真的要删除?\");\r\n");
      out.write("\t\t\tif(res == true) {\r\n");
      out.write("\t\t\t\tvar data=ajaxSubmit(fulllink+\"?action=delete&ids=\" + id,\"publicationForm\");\r\n");
      ...
      out.write("\t\t\t\t\tvar data=ajaxSubmit(fulllink+\"?action=SAVE&ids=\" +  ret['str1'],\"publicationForm\");\r\n");
      out.write("\t\t\t \t\tif(data.exit>0){\r\n");
      out.write("\t\t\t \t\t\t  alert(data.message);\r\n");
      out.write("\t\t\t \t\t\t  return;\r\n");
      out.write("\t\t\t \t\t}\r\n");
      ...
      out.write("\t\t\tvar url_link = fulllink+\"?action=ADD\"+\"&record.worksId=\"+worksId;\r\n");
      out.write("\t\t    openWindow(\"选择媒体\",url_link,0.8,0.8);\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\tvar ps =    getElement(\"query.pageSize\");               if(ps!=null) ps.value=\"15\";\r\n");
      out.write("\t\t\tgoSearch();\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfunction closedialog(ret) {\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(document.getElementById('hide').value==1){\r\n");
      out.write("\t\t\t\t$(\".queryTable\").each(function(){\r\n");
      out.write("\t\t\t\t\tthis.style.display=\"none\";\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("\t var gDiv=window.document.getElementById('pub_box');\r\n");
      ...
      out.write("\t\t var hide2=window.document.getElementById('hide');\r\n");
      out.write("\t\t if(hide2.value==1){\r\n");
  ...
  private boolean _jspx_meth_s_005fform_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(105,0) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setAction("pubWorks");
    // /jsp/works/words/artWorksWords_list.jsp(105,0) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setId("publicationForm");
    // /jsp/works/words/artWorksWords_list.jsp(105,0) name = method type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setMethod("post");
    // /jsp/works/words/artWorksWords_list.jsp(105,0) name = namespace type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t<tbody>\r\n");
        out.write("\t\t<tr>\r\n");
        out.write("  <td class=\"textR\">标题：</td>\r\n");
        out.write("  <td class=\"textL\" width=\"202px\">");
        if (_jspx_meth_s_005ftextfield_005f0(_jspx_th_s_005fform_005f0, _jspx_page_context))
          return true;
        out.write(" </td>\r\n");
        out.write("  <td class=\"textR\">作者：</td>\r\n");
        ...
        if (_jspx_meth_s_005ftextfield_005f2(_jspx_th_s_005fform_005f0, _jspx_page_context))
          return true;
        out.write("</td> \r\n");
        out.write("  <td class=\"textR\">文献提及作品：</td>\r\n");
        out.write("  <td class=\"textL\">");
        ...
        out.write("\t\t</tr>\r\n");
        out.write("\t\t<tr>\r\n");
        out.write("  <td class=\"textR\">引用文献：</td>\r\n");
        out.write("  <td class=\"textL\">");
  ...
  private boolean _jspx_meth_s_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(106,0) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f0.setName("record.hide");
    // /jsp/works/words/artWorksWords_list.jsp(106,0) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(107,0) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(108,0) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(109,0) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(110,0) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(111,0) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(112,0) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f6.setName("query.parameters.worksId");
    // /jsp/works/words/artWorksWords_list.jsp(112,0) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f6.setId("worksId");
  ...
  private boolean _jspx_meth_s_005ftextfield_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(117,34) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f0.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(117,34) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f0.setName("query.parameters.literatureTitle");
  ...
  private boolean _jspx_meth_s_005ftextfield_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(119,20) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f1.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(119,20) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f1.setName("query.parameters.literatureAuther");
  ...
  private boolean _jspx_meth_s_005ftextfield_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(121,20) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f2.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(121,20) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f2.setName("query.parameters.publicationName");
  ...
  private boolean _jspx_meth_s_005ftextfield_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(123,20) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f3.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(123,20) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(127,20) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f4.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(127,20) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(129,20) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f5.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(129,20) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(131,20) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f6.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(131,20) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(133,20) name = style type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f7.setCssStyle("width:200px;");
    // /jsp/works/words/artWorksWords_list.jsp(133,20) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(140,3) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f0.setName("btnQuery");
    // /jsp/works/words/artWorksWords_list.jsp(140,3) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(141,3) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setStyleClass("sbuBtnStyle");
    // /jsp/works/words/artWorksWords_list.jsp(141,3) name = icon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setIcon("addIcon");
    // /jsp/works/words/artWorksWords_list.jsp(141,3) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(142,3) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f2.setStyleClass("sbuBtnStyle");
    // /jsp/works/words/artWorksWords_list.jsp(142,3) name = icon type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f2.setIcon("delIcon");
    // /jsp/works/words/artWorksWords_list.jsp(142,3) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fgrid_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/words/artWorksWords_list.jsp(146,0) name = styleClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setStyleClass("pageTurn");
    // /jsp/works/words/artWorksWords_list.jsp(146,0) name = id type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setId("pub");
    // /jsp/works/words/artWorksWords_list.jsp(146,0) name = page type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setPage("true");
    // /jsp/works/words/artWorksWords_list.jsp(146,0) name = form type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setForm("publicationForm");
    // /jsp/works/words/artWorksWords_list.jsp(146,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setProperty("query");
    // /jsp/works/words/artWorksWords_list.jsp(146,0) name = cellPadding type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fgrid_005f0.setCellPadding("0");
    // /jsp/works/words/artWorksWords_list.jsp(146,0) name = cellSpacing type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_gl_005fgrid_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("   var headAlign=[tCenter,tCenter,tCenter,tCenter,tCenter,tCenter,tCenter,tCenter,tCenter];\r\n");
        out.write("   grid.setHeader(\"#master_checkbox,标题,作者,出版物名称,文献提及作品,引用文献,文献相关人物,文献相关展览,文献相关事件\",null,headAlign);\r\n");
        out.write("   grid.setInitWidthsP(\"5,10,10,10,10,10,15,15,15\");\r\n");
        out.write("   grid.setColAlign(\"center,center,center,center,center,center,center,center,center\");\r\n");
        out.write("   grid.setColTypes(\"ch,link,ro,ro,ro,ro,ro,ro,ro\");\r\n");
        out.write("   grid.setColSorting(\"na,str,str,str,str,str,str,str,str\");\r\n");
        out.write("   gridSort(\"false,false,false,false,false,false,false,false,false\");\r\n");
        out.write("   grid.setSkin(\"dhx_terrace\");\r\n");
        out.write("   grid.init();\r\n");
        out.write("   var gDiv=$$('pub_box');\r\n");
