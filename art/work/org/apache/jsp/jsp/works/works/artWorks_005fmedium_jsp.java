 ...
 * Generated at: 2016-11-29 08:53:21 UTC
...
public final class artWorks_005fmedium_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   String path = request.getContextPath();
	...
	String skinName="dhx_skyblue";
      ...
      out.write("\t\r\n");
      out.write("\tfunction chkTrue(id){\r\n");
      out.write("\t\tif(tree.getUserData(id,\"treeCode\") == \"m1\" || tree.getUserData(id,\"treeCode\") == \"s1\"){\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(tree.isItemChecked(id)){\r\n");
      out.write("\t\t\ttree.setCheck(id,false);\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\ttree.setCheck(id,true);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tvar str = \"\";\r\n");
      out.write("\t\tvar str1 = \"\";\r\n");
      out.write("\t\tvar ids = tree.getAllChecked().split(\",\");\r\n");
      out.write("\t\tfor(var i = 0; i<ids.length; i++){\r\n");
      out.write("\t\t\tvar id = ids[i];\r\n");
      out.write("\t\t\tif(tree.getUserData(id,\"treeCode\") == \"m1\" || tree.getUserData(id,\"treeCode\") == \"s1\"){\r\n");
      out.write("\t\t\t\tcontinue;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tvar mediumCategory=$$('mediumCategory').value;\r\n");
      out.write("\t\t\t  var mediumId;\r\n");
      out.write("\t\t\t  if(mediumCategory == \"1\"){\r\n");
      out.write("\t\t\t\t  mediumId = tree.getUserData(id,\"materialId\");\r\n");
      out.write("\t\t\t  }\r\n");
      out.write("\t\t\t  if(mediumCategory == \"2\"){\r\n");
      out.write("\t\t\t\t  mediumId = tree.getUserData(id,\"shapeId\");\r\n");
      out.write("\t\t\t  }\r\n");
      out.write("\t\t\t  if(str != \"\"){\r\n");
      out.write("\t\t\t\t  str = str + \",\";\r\n");
      out.write("\t\t\t  }\r\n");
      out.write("\t\t\t  str = str + mediumId;\r\n");
      out.write("\t\t\t  if(str1 != \"\"){\r\n");
      out.write("\t\t\t\t  str1 = str1 + \",\";\r\n");
      out.write("\t\t\t  }\r\n");
      out.write("\t\t\t  str1 = str1 + tree.getUserData(id,\"name\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t var ret=new Object();\r\n");
      out.write("\t\t ret['medium']=true;\r\n");
      out.write("\t\t ret['str']=str;\r\n");
      out.write("\t\t ret['str1']=str1;\r\n");
      out.write("\t\t ret['mediumCategory']=mediumCategory;\r\n");
      ...
      out.write("       bDiv.style.width=mainbody.offsetWidth-bDiv.offsetLeft*3-15+\"px\";\r\n");
  ...
  private boolean _jspx_meth_s_005fhidden_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/works/artWorks_medium.jsp(13,1) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f0.setName("record.mediumCategory");
    // /jsp/works/works/artWorks_medium.jsp(13,1) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fhidden_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/works/artWorks_medium.jsp(14,1) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fhidden_005f1.setName("record.id");
    // /jsp/works/works/artWorks_medium.jsp(14,1) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/works/artWorks_medium.jsp(20,2) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f0.setName("btnAdd");
    // /jsp/works/works/artWorks_medium.jsp(20,2) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_gl_005fbutton_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /jsp/works/works/artWorks_medium.jsp(22,3) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_gl_005fbutton_005f1.setName("btnAdd");
    // /jsp/works/works/artWorks_medium.jsp(22,3) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
