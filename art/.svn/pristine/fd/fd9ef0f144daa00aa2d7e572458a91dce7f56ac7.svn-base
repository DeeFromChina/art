...
<script type="text/javascript">
	var hyperlink = "../appManager/appArtistFollowManager.do";
	var fulllink = contextpath + "appManager/appArtistFollowManager.do";
	...
	function goSearch(){
		goappArtistFollowManagerGridSearch();
	}
...
<body onload="init()">
    <div class="special-padding" id="mainDiv">
        <s:form action="appArtistFollowManager" id="appArtistFollowManagerForm" method="post" namespace="/appManager">
            ...
            <table width="99%" id="tbl" cellpadding="0" cellspacing="0" class="queryTable">
            	<tr>
	            	<td width="100%" style="height:30px;" class="textL">
	            		&nbsp;&nbsp;用户账号：<s:textfield style="width:120px;" name="query.parameters.accountName"></s:textfield>
	            		&nbsp;&nbsp;艺术家：<s:textfield style="width:120px;" name="query.parameters.artistName"></s:textfield>
            ...
            <gl:grid styleClass="pageTurn" id="appArtistFollowManager" page="true" form="appArtistFollowManagerForm"  property="query" cellPadding="0" cellSpacing="0">
                var grid = new dhtmlXGridObject();
                grid.setImagePath(imagePath);
                var headAlign = [tCenter,tCenter,tCenter,tCenter,tCenter,tCenter];
                grid.setHeader("#master_checkbox,艺术家图片,艺术家中文名,艺术家英文名,用户账号,关注时间",null, headAlign);
                ...
                grid.init();
                var gDiv = $$('appArtistFollowManager_box');
            </gl:grid>
        </s:form>
    </div>
	...
	<script type="text/javascript">
	    if(window.addEventListener) {
		 ...
		 var gDiv=window.document.getElementById('appArtistFollowManager_box');
