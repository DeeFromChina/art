	        ...
	        <table cellpadding="0" cellspacing="0" width="99%" class="formTable">
	            ...
	            <tr>
	                ...
	                <td colspan="3" class="textL">
	                    <table cellpadding="0" cellspacing="0" width="100%" class="tbnBtnStyle" border="0" id="tblUpload">
	                        <tr>
	                            <td class="textL" style="width:90%;"></td>
	                            <td>
	                                <input type="button" style="width:50px;" value="增加" onclick="addFileRow('tblUpload1')"/>
	                            </td>
	                        </tr>
...
function goResize(){
	console.log('Resize');
   fDiv.style.width = mainbody.offsetWidth-fDiv.offsetLeft*2 + "px";console.log(fDiv.style.width);
   bDiv.style.width = mainbody.offsetWidth-bDiv.offsetLeft*2 + "px";console.log(bDiv.style.width);
   fDiv.style.height = mainbody.offsetHeight - bDiv.offsetHeight-fDiv.offsetTop*2 + "px";console.log(fDiv.style.height);
   bDiv.style.top = fDiv.offsetHeight+fDiv.offsetTop*2 - 5 + "px";console.log(bDiv.style.top);
   if(btbl){
