...
<div class="special-padding">   
  <div id="left_div"  style="float:left;background-color:white;width:100%;height:100%;overflow-y:auto;" >
  </div>
</div>
<script type="text/javascript">
	  ...
	  function init(){
		  ...
		  left_div.style.width=mainbody.offsetWidth-16+"px";
		  left_div.style.height=mainbody.offsetHeight-66+"px";
	  }
