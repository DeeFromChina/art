...
<script language="javascript">		
	...
	function checkFormInput(){
		...
		if(!checkString(getElement('form.record.eduDesc'),"描述",1000,true)) return;
		return true;
	}
	...
	<s:form action="ArtistEdu" id="ArtistEduForm" method="post" namespace="/artist">
			...
			<table cellpadding="0" cellspacing="0" width="99%" class="formTable">
				<tr>
					...
					<td width="25%">
						<s:textfield name="form.record.eduTime" placeholder="xxxx年xx月xx日"/>
					</td>
					<td colspan="2" />
				</tr>
				<tr>
					<td class="textR" valign="top"><font color="red">*</font>事件：</td>
					<td colspan="3" ><s:textarea name="form.record.eduDesc"></s:textarea></td>
			    </tr> 
		 	</table>
	</div>
