...
<body>
	...
	<script type="text/javascript">
		...
		tree.setXMLAutoLoading("<%=CONTEXT_PATH%>artist/ArtistInformation.do?action=ANCESTRALHOME");
		tree.loadXML("<%=CONTEXT_PATH%>artist/ArtistInformation.do?action=ANCESTRALHOME&id=0");
