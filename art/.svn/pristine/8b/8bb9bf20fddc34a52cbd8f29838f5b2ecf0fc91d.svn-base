...
<script language="javascript">  
	var hyperlink = "../artist/ArtistCollectAgency.do";	
	...
	function goAdd()  {
	    ...
	    openWindow("添加收藏机构",fulllink+'?action=ADD&record.artistId=' + artistId,0.6,0.6);
	}
	
	function view(id) {
	       var url_link=syslink+'?action=VIEW&record.id=' + id;
	       editMode="VIEW";
	       openWindow("查看收藏机构",url_link,0.6,0.6);	
	}
	...
	function goModify(){
		...
		editMode="EDIT";
	    openWindow("修改收藏机构",url_link,0.6,0.6);	  
	}
...
//		openWindow("导入收藏机构",url_link,0.5,0.5);
//	}
//
	...
	<div class="special-padding" id="mainDiv">
		<s:form action="ArtistCollect" id="ArtistCollectForm" method="post" namespace="/artist" enctype="multipart/form-data">
			...
			<gl:grid styleClass="pageTurn" id="ArtistCollect" page="true" form="ArtistCollectForm"  property="query" cellPadding="0" cellSpacing="0">
				...
				grid.setHeader("#master_checkbox,收藏机构名称,时间,作品,描述",null, headAlign);
				grid.setInitWidthsP("5,20,10,30,35");
