...
<head>
   <%@include file="/common/header.jsp" %>
	...
	function goSubmit(){
		  if(!checkString(getElement('record.itemName'),"代码名称",60,true)) return;
		  if(!checkString(getElement('record.itemValue'),"代码值",20,true)) return;
   ...
   <s:hidden name="record.id" />
			...
			<table id="tblForm" cellpadding="0" cellspacing="0" width="100%" class="formTable">
			 <tr>
				...
				<td width="35%">
					<s:textfield name="record.itemName" />
				</td>
			</tr>
			<tr>
				<td class="textR"><font color="red">*</font>代码值：</td>
				  <td>
					   <s:textfield name="record.itemValue" />
				  </td>
				<td colspan=2></td>
			</tr>
			<tr>
