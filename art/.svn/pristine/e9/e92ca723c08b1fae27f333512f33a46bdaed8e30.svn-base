...
<div id="btnDiv" class="btnDiv">
	...
	function goResize(){
		...
		window.frames["page_1"].location.href = auctionVideoLink + '?action=LIST&query.parameters.auctionId=' + $$('auctionId').value;
		window.frames["page_2"].location.href = auctionWordsLink + '?action=LIST&query.parameters.auctionId=' + $$('auctionId').value;
