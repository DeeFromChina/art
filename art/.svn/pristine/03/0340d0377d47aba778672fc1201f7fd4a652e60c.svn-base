...
<div id="formDiv" class="formDiv"
     style="left:0px;top:0px;text-align:left!important;background:white;border:1px solid #c1b2ff!important;">
    <s:form method="post" action="ArtLiteratureOther" namespace="/literature">
        <s:hidden property="record.ids"/>
        <s:iterator value="query.recordSet" id="item">
            <input type="radio" style="width:16px;" <s:property value="CHECKED"/> name="artArtistId" value="<s:property value='id'/>" title="<s:property value='cname'/>"/>
            <img style="width:16px;" src="<%=CONTEXT_PATH%>dhtmlx/imgs/icon/people.gif"/>
            <span style="width:100px;"><s:property value="cname"/></span><br/>
        </s:iterator>
    </s:form>
</div>
